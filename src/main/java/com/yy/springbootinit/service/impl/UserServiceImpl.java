...
import com.yy.springbootinit.model.enums.UserRoleEnum;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    public static final String SALT = "yyy";
...
//        System.out.println(currentUser.getScore());
    ...
    public UserVO getUserVOById(Long id) {
        ThrowUtils.throwIf(id <= 0,ErrorCode.PARAMS_ERROR,"输入异常");

        User user = this.getById(id);
        ThrowUtils.throwIf(user == null, ErrorCode.NOT_FOUND_ERROR, "账户不存在");
